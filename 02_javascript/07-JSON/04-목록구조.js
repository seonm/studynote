...
// for~of문을 사용할 경우 몇 번째 항목인지를 알기 위해서는
// 반복문 시작전에 별도의 초기식과 반복문 안에 별도의 증감식을 추가해야 한다.(while문과 유사)
let i = 0;
for(const a of classRoom.student){
  console.group('for~of문 ' + i + '번째 학생');
    console.log('학번: ' + a.studno);
    console.log('학년: ' + a.grade);
