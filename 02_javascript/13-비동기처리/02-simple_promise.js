...
function getLuckyResult(){
  // Promise객체는 resolve함수와, reject 함수를 파라미터로 받는 콜백이 필요함.
...
Promise 클래스에 전달된 생성자 파라미터(콜백함수)가 실행될 것이다.
-> resolve 혹은 reject가 이미 호출된 상태라는 의미
*/
