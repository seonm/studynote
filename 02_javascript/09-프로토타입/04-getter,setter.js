...
Object.defineProperty(User4.prototype, 'id', {
  get: function(){
    console.log('id에 대한 getter 호출된다.');
    // 멤버변수의 값을 반환 하는 기능
    // 반환 전에 필요하다면 멤버 변수의 값을 가공하여 반환할 수도 있다.
    return this._id;
  },
  set: function(param){
    console.log('id에 대한 setter 호출된다.');
...
Object.defineProperty(User4.prototype, 'email', {
  get: function(){
    console.log('email에 대한 getter 호출된다.');
    return this._email;
  },
  set: function(param){
    console.log('email에 대한 setter 호출된다.');
    this._email = param;
  }
})
