...
/*
  ...
  @param {string} compare : 검사 대상에 대한 CSS선택자
...
compareTo(origin, compare, msg){
  ...
  let dsc = document.querySelector(compare).value.trim(); //비교할값을 가져온다.
...
/*
  select의 값이 선택되었는 지를 체크한다.
  @param {string} selector : 검사할 대상의 CSS선택자
  @param {string} msg : 검사에 실패할 경우 표시할 메시지
*/
dropdown(selector, msg){
  const drop = document.querySelector(selector).value;
  if(drop == ''){
    throw new BadRequestException(msg, selector);  
  }
}
...
/*
  한글으로만 이루어졌는지 검사하기 위해 field()를 간접적으로 호출한다.
  @param {string} selector : 검사할 대상의 CSS선택자
  @param {string} msg : 표시할 메시지
*/
kor(selector,msg){
...
/*
  -없이 핸드폰 번호 형식인지 검사하기 위해 field()를 간접적으로 호출한다.
  @param {string} selector : 검사할 대상의 CSS선택자
  @param {string} msg : 표시할 메시지
*/
callphone(selector,msg){
  return this.field(selector, msg, /^01(?:0|1|[6-9])(?:\d{3}|\d{4})\d{4}$/);
}

/*
  -없이 집전화 형식인지 검사하기 위해 field()를 간접적으로 호출한다.
  @param {string} selector : 검사할 대상의 CSS선택자
  @param {string} msg : 표시할 메시지
*/
